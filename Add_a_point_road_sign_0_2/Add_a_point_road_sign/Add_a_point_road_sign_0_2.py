...
from .Setup_0_4 import Setup
from .Mouse_point_tool_0_3 import Mouse_point_tool
from .My_QSvgWidget_0_2 import My_QSvgWidget
from .My_QLabel_0_1 import My_QLabel
from .Type_preview_Dialog_0_1_b import Type_preview_Dialog
from .My_LineEdit_0_1 import My_LineEdit
...
class Add_a_point_road_sign(QtWidgets.QMainWindow):
    ...
    def __init__(self, iface):
        ...
        self.icon = QtGui.QIcon(os.path.join(self.base_path, 'images', 'Add_a_point_road_sign_ICON.png'))
    ...
    def initGui(self):
        ...
        uic.loadUi(os.path.join(self.base_path, 'ui', 'Add_a_point_road_sign_0_2.ui'), self)
